      ...
      <div className="relative p-24 lg:grid lg:grid-cols-2 sm:grid-cols-1 justify-center items-center  h-screen z-0 container mx-auto">
        ...
        <div className="wrapper flex items-center ">
          <img
            ...
            src={pp}
            // style={{ boxShadow: "0px 0px 250px px rgba(127, 17, 224, 0.1)" }}
          ...
          <div className="flex flex-col text-white text-2xl gap-5">
            <a href="https://www.facebook.com/dady.bima.5" className="duration-300 ease-in-out hover:text-[#B895FD]">
              <FontAwesomeIcon icon={faSquareFacebook} />
            </a>
            <a href="https://instagram.com/dybim__" className="duration-300 ease-in-out hover:text-[#B895FD]">
              <FontAwesomeIcon icon={faSquareInstagram} />
            </a>
            <a href="https://www.linkedin.com/in/dady-bima/"  className="duration-300 ease-in-out hover:text-[#B895FD]">
              <FontAwesomeIcon icon={faLinkedin} />
            </a>

            <a href="https://wa.me/087812566311" className="duration-300 ease-in-out hover:text-[#B895FD]">
